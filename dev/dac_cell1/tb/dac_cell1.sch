...
N 1240 -660 1240 -640 { lab=#net1}
N 1370 -660 1370 -640 { lab=#net1}
N 1240 -580 1370 -580 { lab=sourceM2}
N 1240 -720 1370 -720 { lab=vsup}
N 1240 -650 1370 -650 { lab=#net1}
...
N 760 -510 840 -510 { lab=iref}
N 650 -510 700 -510 { lab=iref}
N 700 -510 760 -510 { lab=iref}
...
C {devices/iopin.sym} 650 -510 2 0 {name=p2 lab=iref}
...
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} 1030 -520 0 0 {name=l1 sig_type=std_logic lab=sourceM3M4}
C {devices/lab_pin.sym} 1150 -530 0 0 {name=l2 sig_type=std_logic lab=sourceM2}
C {devices/lab_pin.sym} 1310 -650 1 0 {name=l3 sig_type=std_logic lab=parR}
