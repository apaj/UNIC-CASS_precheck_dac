...
N 1480 -600 1480 -590 { lab=#net4}
N 1480 -590 1480 -580 { lab=#net4}
...
N 1110 -620 1560 -620 { lab=#net5}
N 1110 -600 1480 -600 { lab=#net4}
N 1110 -580 1400 -580 { lab=GND}
N 1110 -560 1340 -560 { lab=Vsw}
N 1110 -540 1260 -540 { lab=#net6}
...
wrdata $DEV_PATH/res/dac_cell1_extracted_tran_cur.res i(V4) i(V5)
wrdata $DEV_PATH/res/dac_cell1_extracted_tran_vol.res Vsw
.endc
"}
...
C {dac_cell1.sym} 960 -560 0 0 {name=x1}
