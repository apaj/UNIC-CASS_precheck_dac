...
C {devices/code_shown.sym} 918.75 -1307.5 0 0 {name=NGSPICE
only_toplevel=true
value="
...
set wr_vecnames
set wr_singlescale
wrdata miel21_tb_nmos_transfer_single.res @m.xm1.msky130_fd_pr__nfet_g5v0d10v5[id]
.endc
"}
C {devices/gnd.sym} 1780 -800 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 1620 -1020 0 0 {name=l4 sig_type=std_logic lab=drain}
C {sky130_fd_pr/nfet3_g5v0d10v5.sym} 1600 -900 0 0 {name=M1
L=0.5
W=1
body=GND
nf=1
