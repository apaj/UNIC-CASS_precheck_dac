...
C {devices/code_shown.sym} 10 -300 0 0 {name=NGSPICE
only_toplevel=true
value="
...
wrdata miel21_tb_opamp_dc_cm.res incm outcm
+pow x1.nsources x1.d1 x1.d2 x1.bias
.endc
"}
...
C {devices/title.sym} 160 50 0 0 {name=l8 author="Aleksandar Pajkanovic"}
