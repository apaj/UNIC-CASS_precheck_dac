...
C {devices/code_shown.sym} 698.75 -1027.5 0 0 {name=NGSPICE
only_toplevel=true
value="
...
.control
dc V2 0 3.3 0.01 V1 0 3.3 0.33
set wr_vecnames
set wr_singlescale
wrdata miel21_tb_nmos_out_param_VGS.res @m.xm1.msky130_fd_pr__nfet_g5v0d10v5[id]
.endc
"}
