...
C {devices/vsource.sym} 1500 -840 0 0 {name=V1 value=1.8}
C {devices/vsource.sym} 1780 -950 0 0 {name=V2 value=1.8}
...
C {devices/code_shown.sym} 838.75 -1127.5 0 0 {name=NGSPICE
only_toplevel=true
value="
...
.control
  ...
  set c = \\" \\"
  dowhile ix <= 10
    alter @m.xm1.msky130_fd_pr__nfet_g5v0d10v5[m] = ix
    run
    set c = ( $c dc\{$&ix\}.@m.xm1.msky130_fd_pr__nfet_g5v0d10v5[id] )
    let ix = ix + 1
  end

set wr_vecnames
set wr_singlescale
wrdata miel21_tb_nmos_transfer_param_Width.res $c
.endc
"}
